...
<body>
    ...
    <div class="formbody">
    	<div class="formtitle"><span>修改单位</span></div>
	    <form action="<?php echo U('edit');?>" method="post" class="layui-form">
	    	<input type="hidden" name="curr" value="<?php echo ($curr); ?>">
	    	<input type="hidden" name="co_id" value="<?php echo ($list["co_id"]); ?>">
            <div class="layui-form-item">
                <div class="layui-inline">
                    <label class="layui-form-label">单位名称</label>
                    <div class="layui-input-inline"><input type="text" name="co_name" class="layui-input" value="<?php echo ($list["co_name"]); ?>"></div>
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-inline">
                    <label class="layui-form-label">单位负责人</label>
                    <div class="layui-input-inline"><input type="text" name="co_people"  class="layui-input" value="<?php echo ($list["co_people"]); ?>"></div>
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-inline">
                    <label class="layui-form-label">负责人电话</label>
                    <div class="layui-input-inline"><input type="text" name="co_tel" lay-verify="phone" class="layui-input" value="<?php echo ($list["co_tel"]); ?>"></div>
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-inline">
                    <label class="layui-form-label">单位地址</label>
                    <div class="layui-input-inline"><input type="text" name="co_address"  class="layui-input" value="<?php echo ($list["co_address"]); ?>"></div>
                </div>
            </div>
			<div class="layui-form-item">
